...
публичным справочным данным администрации. Он не подключается к внутренним
базам данных и не раскрывает служебные таблицы, схемы, IP-адреса или
непубличные поля.
...
Сейчас MCP-сервер публикует:

- муниципальные школы;
- муниципальные детские сады;
- дату последнего обновления сведений ФНС/ЕГРЮЛ.
...
Данные формируются из публичных и утвержденных источников:
...
- нет прямого подключения к внутренним базам данных;
