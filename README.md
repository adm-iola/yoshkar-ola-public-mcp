...
публичным справочным данным администрации. В первом релизе публикуются только
утвержденные наборы открытых данных.
...
Сервер предназначен только для публикации утвержденных открытых данных.
